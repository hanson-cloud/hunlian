...
<header>
  <nav id="nav">
    <ul>
      ...
      <li><a href="/news/jsex/" target="_blank" title="active/js 实例代码演示">JS实例</a></li>
    </ul>
    <!--获取当前页导航 高亮显示标题--> 
  </nav>
</header>
    ...
    <ul class="bloglist">
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="active/images/s1.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="active/images/s2.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="active/images/s3.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
          <ul class="textinfo">
            <a href="/"><img src="active/images/s4.jpg"></a>
            <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
          </ul>
          <ul class="details">
            <li class="likes"><a href="#">102</a></li>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="active/images/s5.jpg"></a>
