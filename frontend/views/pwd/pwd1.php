...
<div class="m-side">
    <div class="side-1">
        ...
        <div class="side-user-info">
            <div class="side-name"><a href="http://album.zhenai.com/u/102004007" target="_blank" class="side-user-name" id="uid">会员<?php echo yii::$app->session->get('user_name')?></a></div>
            <div class="side-icon">
...
$("#next2").click(function()
{
    ...
    // }
        $.ajax({
            url:'?r=pwd/pwd_pwd&upwd='+upwd+'&id='+s1,
            Type:"get",
            dataType:'json',
