...
<script src="assets/web/register_info/screenfix.js"></script>
	...
	<!-- 		 	<input name="isReliveCardMember" value="-1" type="hidden">
				...
				<div class="col-form">
					<label>我的手机号：</label>
					<input autocomplete="off" class="input-text" placeholder="您的手机号" name="tel" id="MyPhoneInputID" data-check="#MyPhoneCheck" type="text">
				...
				<div class="col-form">
					<label>创建密码：</label>
					<input autocomplete="off" class="input-text" placeholder="请输入密码" name="user_pwd" id="MyPassword" data-check="#MyPasswordCheck" onpaste="return false" type="password">
				...
				<div class="col-form">
					<label>确认密码：</label>
					<input autocomplete="off" class="input-text" placeholder="请再输入一次密码" name="" id="CheckMyPSW" data-check="#CheckMyPSWCheck" type="password">
